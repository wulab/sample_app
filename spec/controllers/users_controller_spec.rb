...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    it "should show the user's microposts" do
      post1 = Factory(:micropost, :user => @user, :content => "Foo bar")
      post2 = Factory(:micropost, :user => @user, :content => "Baz quux")
      get :show, :id => @user
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => "Foo Bar", :email => "foo@bar.com", :password => "foobar", :password_confirmation => "foobar" }
      end
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => "Example User", :email => "user@example.com", :password => "barbaz", :password_confirmation => "barbaz" }
      end
  ...
  describe "authentication of edit/update pages" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        wrong_user = Factory(:user, :email => "foobar@example.com")
